...
ですので、進め方や考え方について、世の中のWeb制作会社とはちがった側面を持っていると思えることがよくあります。

> - エンジニアとの連携・会話が日常的に発生する。
> - 「わかりやすいもの・効果のあるもの」よりも「キレイなもの・おかしみのあるもの」
> - 維持・管理できないドキュメントは極力作成しないかわりに、ドキュメント不要なレベルまで議論を交わす。
> - デザインしたら当然のようにコードも書く。
> - 「リリース＝終わり」ではなく「リリース＝改善の始まり」

「デザイン」という単語は指し示す範囲があいまいで、ひとりあるきしやすく、とらえどころのない概念になりがちです。そのため「Webデザイナー」の職域や仕事の進め方についても、画一的に規定するのはとても難しいことです。

> - 見た目を整えるひとのことなのか。
> - 導線や画面詳細を設計するひとのことなのか。
> - ユーザーとの接点における問題を発見し解決するひとのことなのか。
...
詳しくは「[要求、要件定義をする前に、あなたについてしつこく聞くこと](//management/requirement/before_requirement/)」をご参照ください。
...
- 身近なひとがターゲットユーザーに近ければ、その人をペルソナ的に扱うと具体性が増します。
...
- イレギュラーなパターンを考えすぎると、ブレたり冗長なシナリオになるので、代表的な行動に絞って構いません。
...
### Google Analytics、Google Tag Manager、Search Consoleの準備・確認
